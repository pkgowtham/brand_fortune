    ...
    <div className={classes.tablebutton}>
      <div className={classes.buttonContainer}>
        ...
        <Button
          variant="contained"
          color="primary"
          onClick={() => navigate("/layout/marketplacecreate")}
        >
          Add New
        </Button>
      </div>
      <TableContainer className={classes.tablecontainer} component={Paper}>
        <Table className={classes.table} aria-label="simple table">
          <TableHead>
            <TableRow>
              <TableCell className={classes.Tablecell}>Market Place Name</TableCell>
          ...
          <TableBody>
            {deleterows?.data?.map((row, index) => (
              <TableRow key={row._id}>
                ...
                <TableCell className={classes.Tablebody}>{row.code}</TableCell>
                ...
                <Tooltip title="Edit" placement="bottom-start">
                  <EditIcon
                    ...
                    cursor='pointer'
                    onClick={() =>
                      navigate("/layout/marketplacecreate", { state: { ...row } })
                    }
                  >
                    Edit
                  </EditIcon>

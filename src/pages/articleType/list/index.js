    ...
    <div className={classes.tablebutton}>
      <div className={classes.buttonContainer}>
        ...
        <Button
          variant="contained"
          color="primary"
          onClick={() => navigate("/layout/articletypecreate")}
        >
          Add New
        </Button>
      </div>
          ...
          <TableBody>
            {deleterows?.data?.map((row, index) => (
              <TableRow key={row._id}>
                ...
                <TableCell className={classes.Tablebody}>{row.brand.map((user)=>user.label).join(" , ")}</TableCell>
                ...
                <Tooltip title="Edit" placement="bottom-start">
                  <EditIcon
                    ...
                    cursor='pointer'
                    onClick={() =>
                      navigate("/layout/articletypecreate", { state: { ...row } })
                    }
                  >
                    Edit
                  </EditIcon>

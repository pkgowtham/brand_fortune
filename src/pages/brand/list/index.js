  ...
  const initialTableData = async () => {    
    ...
    await axio
      ...
      .catch((err) => {
        ...
        enqueueSnackbar("Failed in Deleting", { variant: "error" });
      });
  };
    ...
    <div className={classes.tablebutton}>
      <div className={classes.buttonContainer}>
        ...
        <Button
          variant="contained"
          color="primary"
          onClick={() => navigate("/layout/brandcreate")}
        >
          Add New
        </Button>
      </div>
        ...
        <Table className={classes.table} aria-label="simple table">
          <TableHead>
            ...
            <TableCell className={classes.Tablecell}>S.No</TableCell>
              ...
              <TableCell className={classes.Tablecell}>Account Manager</TableCell>
          ...
          <TableBody>
            {deleterows?.data?.map((row, index) => (
              <TableRow key={row._id}>
                ...
                <TableCell className={classes.Tablebody}>{row.userId.map((user)=>user.firstName).join(" , ")}</TableCell>
                ...
                <Tooltip title="Edit" placement="bottom-start">
                  <EditIcon
                    ...
                    cursor='pointer'
                    onClick={() =>
                      navigate("/layout/brandcreate", { state: { ...row } })
                    }
                  >
                    Edit
                  </EditIcon>

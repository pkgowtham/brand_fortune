    ...
    <div className={classes.tablebutton}>
      <div className={classes.buttonContainer}>
        ...
        <Button
          variant="contained"
          color="primary"
          onClick={() => navigate("/layout/gendercreate")}
        >
          Add New
        </Button>
      </div>
      <TableContainer className={classes.tablecontainer} component={Paper}>
        <Table className={classes.table} aria-label="simple table">
          <TableHead>
            <TableRow>
              <TableCell className={classes.Tablecell}>Gender Name</TableCell>
              ...
              <TableRow key={row._id}>
                ...
                <Tooltip title="Edit" placement="bottom-start">
                  <EditIcon
                    ...
                    cursor='pointer'
                    onClick={() =>
                      navigate("/layout/gendercreate", { state: { ...row } })
                    }
                  >
                    Edit
                  </EditIcon>

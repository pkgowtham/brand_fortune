export const ACTION_TYPE = {
  ...
  GET_LIST_QUERY_SAGA: "GET_LIST_QUERY_SAGA",
  GET_LIST_QUERY_PENDING: "GET_LIST_QUERY_PENDING",
  GET_LIST_QUERY_FULFILLED: "GET_LIST_QUERY_FULFILLED",
  GET_LIST_QUERY_REJECTED: "GET_LIST_QUERY_REJECTED",
  GET_LIST_QUERY_INITIAL_STATE: "GET_LIST_QUERY_INITIAL_STATE",

  CREATE_QUERY_SAGA: "CREATE_QUERY_SAGA",
  CREATE_QUERY_PENDING: "CREATE_QUERY_PENDING",
  CREATE_QUERY_FULFILLED: "CREATE_QUERY_FULFILLED",
  CREATE_QUERY_REJECTED: "CREATE_QUERY_REJECTED",
  CREATE_QUERY_INITIAL_STATE: "CREATE_QUERY_INITIAL_STATE",

  UPDATE_QUERY_SAGA: " UPDATE_QUERY_SAGA",
  UPDATE_QUERY_PENDING: "UPDATE_QUERY_PENDING",
  UPDATE_QUERY_FULFILLED: "UPDATE_QUERY_FULFILLED",
  UPDATE_QUERY_REJECTED: "UPDATE_QUERY_REJECTED",
  UPDATE_QUERY_INITIAL_STATE: "UPDATE_QUERY_INITIAL_STATE",

  DELETE_QUERY_SAGA: "DELETE_QUERY_SAGA",
  DELETE_QUERY_PENDING: "DELETE_QUERY_PENDING",
  DELETE_QUERY_FULFILLED: "DELETE_QUERY_FULFILLED",
  DELETE_QUERY_REJECTED: "DELETE_QUERY_REJECTED",
  DELETE_QUERY_INITIAL_STATE: "DELETE_QUERY_INITIAL_STATE",

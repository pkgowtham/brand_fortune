...
const projectReducer = (state = initState, action) => {
  switch (action.type) {
    case ACTION_TYPE.GET_LIST_PROJECT_PENDING: {
      return {
        ...state,
    ...
    case ACTION_TYPE.GET_LIST_PROJECT_FULFILLED: {
      return {
        ...state,
        isLoadingGetList: false,
    ...
    case ACTION_TYPE.GET_LIST_PROJECT_REJECTED: {
      return {
        ...state,
        isLoadingGetList: false,
        isSuccessGetList: false,
    ...
    case ACTION_TYPE.GET_LIST_PROJECT_INITIAL_STATE: {
      return {
        ...state,
        isLoadingGetList: false,
        isSuccessGetList: false,
    ...
    case ACTION_TYPE.CREATE_PROJECT_PENDING: {
      return {
        ...state,
    ...
    case ACTION_TYPE.CREATE_PROJECT_FULFILLED: {
      return {
        ...state,
        isLoadingCreate: false,
    ...
    case ACTION_TYPE.CREATE_PROJECT_REJECTED: {
      return {
        ...state,
        isLoadingCreate: false,
        isSuccessCreate: false,
    ...
    case ACTION_TYPE.CREATE_PROJECT_INITIAL_STATE: {
      return {
        ...state,
        isLoadingCreate: false,
        isSuccessCreate: false,
    ...
    case ACTION_TYPE.UPDATE_PROJECT_PENDING: {
      return {
        ...state,
    ...
    case ACTION_TYPE.UPDATE_PROJECT_FULFILLED: {
      return {
        ...state,
        isLoadingUpdate: false,
    ...
    case ACTION_TYPE.UPDATE_PROJECT_REJECTED: {
      return {
        ...state,
        isLoadingUpdate: false,
        isSuccessUpdate: false,
    ...
    case ACTION_TYPE.UPDATE_PROJECT_INITIAL_STATE: {
      return {
        ...state,
        isLoadingUpdate: false,
        isSuccessUpdate: false,
    ...
    case ACTION_TYPE.DELETE_PROJECT_PENDING: {
      return {
        ...state,
    ...
    case ACTION_TYPE.DELETE_PROJECT_FULFILLED: {
      return {
        ...state,
        isLoadingDelete: false,
    ...
    case ACTION_TYPE.DELETE_PROJECT_REJECTED: {
      return {
        ...state,
        isLoadingDelete: false,
        isSuccessDelete: false,
    ...
    case ACTION_TYPE.DELETE_PROJECT_INITIAL_STATE: {
      return {
        ...state,
        isLoadingDelete: false,
        isSuccessDelete: false,
